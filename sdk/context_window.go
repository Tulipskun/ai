...
// estimateTurnTokens intentionally uses a conservative character-based
// approximation. The SDK does not own a provider tokenizer; this keeps the
// sliding window deterministic while leaving room for a provider tokenizer
// to replace the estimator later.
